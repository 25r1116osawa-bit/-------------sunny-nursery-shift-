...
export const INITIAL_STAFF = [
  { id: '1', name: '大澤 沙織', type: EmploymentType.FULL_TIME, color: STAFF_COLORS[0] },
  { id: '2', name: '鈴木 太郎', type: EmploymentType.FULL_TIME, color: STAFF_COLORS[1] },
  { id: '3', name: '高橋 健太', type: EmploymentType.PART_TIME, color: STAFF_COLORS[2] },
];
